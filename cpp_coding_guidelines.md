# 动机
为了帮助团队内Java经验为主的开发者快速成长为专业C++开发者，让项目成员以一致的方式做设计和实现，从而实现更高效的协作，我们编撰该文档。

文档里包含需共同遵从的原则和规则、编码风格，市面上有很多类似的文档，比如《Google C++编码规范》、《CppCoreGuidelines》，但我觉得这些文档，大多太长太细节，难以在团队内让每个人都深刻理解，然后做到完全遵守，也就是说可实施性稍欠；另一方面，在设计和编码理念等重要方面没有涉及，我们需要既全面又简单可实施的C++编码向导。

所以，我们既参考了这些文档，又补充了一些条目，任何新增内容，都秉持一个原则：“摒弃个人好恶，有广泛共识”，也就是说只有业界有广泛且强共识的内容才会被考虑增补进来。
