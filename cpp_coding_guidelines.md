...
为了帮助以Java经验为主的团队快速适应C++开发，让项目成员以一致的方式做设计和实现，让大家更高效的协作，架构师编写了该文档。文档里包含需共同遵从的原则和规则、编码风格，我们既参考了市面上流行的C++编码文档，又补充了一些条目，任何增补内容都秉持一个原则：“摒弃个人好恶，只吸取在业界有广泛共识的最重要的部分内容”。
